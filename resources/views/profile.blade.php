        ...
        <div class="proffile__post">
            <div class="container">
                <div class="profile__post-ihner">
                    ...
                    <div class="profile__post-input">
                        <textarea name="" id="" placeholder="Write some text here..." class="post__input-place"></textarea>
                        <button class="post__send">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="23" viewBox="0 0 24 23"
                                fill="none">
                                <g clip-path="url(#clip0_283_42)">
                                    <path d="M21.4276 11.3134H11.0567" stroke="white" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path
                                        d="M21.4281 11.3138L8.70017 17.4421L11.0572 11.3138L8.70017 5.18557L21.4281 11.3138Z"
                                        stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                                <defs>
                                    <clipPath id="clip0_283_42">
                                        <rect width="16" height="16" fill="white"
                                            transform="translate(12) rotate(45)" />
                                    </clipPath>
                                </defs>
                            </svg>
                        </button>
